...
HD_PWD='/home/jc2409/Projects/Comp_Arch_Onur_Labs/Lab_03/combinational_circuits/combinational_circuits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segment_decode.tcl
